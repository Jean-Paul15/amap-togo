...
export default function AdminHomePage() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      {/* En-tete moderne avec chiffre d'affaires compact */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100 rounded-xl px-4 py-2.5 shadow-sm">
      ...
      {/* Cartes statistiques - 4 colonnes sur desktop */}
